...
GITHUB_PATH_PREFIX = "huggingface/education-toolkit/blob/main/"

CHAPTER_TO_NB = {
    "Build and Host Machine Learning Demos with Gradio & Hugging Face": "02_ml-demos-with-gradio",
    "Getting Started with Transformers": "03_getting-started-with-transformers"
}
